...
// Kronometre ve bağlantı ikonları — Yaptım sayfasındaki satır düğmeleri.
...
// Şifre alanındaki "göster" düğmesi (bkz. SifreGirdisi).
...
// Şifre alanındaki "gizle" düğmesi: aynı göz, üstü çizili.
export function IconEyeOff({ size = 18, color = "currentColor" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
