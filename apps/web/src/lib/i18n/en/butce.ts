...
export const butce: TranslationDict = {
  ...
  "Bu kayıt neyle ilgili?": "What is this entry for?",
  "Neyle ilgili? (isteğe bağlı)": "What is it for? (optional)",
  "Görev seç (isteğe bağlı)": "Pick a task (optional)",
  "Kayıt seçilen yerin defterine yazılır ve buraya toplanarak gelir.":
    "The entry goes into the chosen place's ledger and rolls up here.",
  "Düzenli yap": "Make recurring",
  "Düzenli hâle getir": "Make this recurring",
  "Düzenli hâle getirilemedi.": "Couldn't make it recurring.",
  "Bu kayıt defterde kalır; tekrarı bir sonraki vadeden başlar.":
    "This entry stays in the ledger; the repeat starts from the next due date.",
  "Tekrar aralığı": "Repeat interval",
  "Otomatik oluşan bir kaydın görev bağı değiştirilemez":
    "The task link of an automatically created entry can't be changed",
