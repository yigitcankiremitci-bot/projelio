...
export const demoRandevu: TranslationDict = {
  ...
  "Kaydedildi. Randevu alma hâlâ kapalı — açmak için yukarıdaki düğmeyi kullan.": "Saved. Bookings are still closed — use the button above to open them.",
  "Randevu alma açık": "Bookings are open",
  "Randevu alma kapalı": "Bookings are closed",
  "Randevu almayı aç": "Open bookings",
  "Sayfayı aç": "Open page",
  "Çalışma saatleri hazır, ama herkese açık sayfa \"şu an kapalı\" gösteriyor.": "Working hours are set, but the public page says \"closed for now\".",
