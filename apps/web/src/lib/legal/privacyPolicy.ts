    ...
    tr: [
      ...
      },
      {
        ...
        p: [
          ...
          "Modeli çalıştıran tedarikçi Anthropic, PBC'dir (Amerika Birleşik Devletleri). Hizmetin kesintisiz sürmesi için yedek tedarikçi olarak MiniMax ve Z.ai (Zhipu AI) tanımlanabilir; bu iki tedarikçinin sunucuları Çin Halk Cumhuriyeti'ndedir. Yedeğe geçiş yalnızca birincil tedarikçi geçici olarak yanıt veremediğinde olur. Google hesabınızdan gelen verileri (ör. Google Takvim etkinlikleri) içeren istekler hiçbir zaman yedek tedarikçiye gönderilmez; Anthropic o an yanıt veremiyorsa istek yanıtlanmaz (bkz. 7. madde).",
      ...
      },
      {
        ...
        p: [
          ...
          "Yurt dışına yalnızca şu hâllerde veri gider: (a) Lio'ya gönderdiğiniz mesajlar ve bağlam, modeli çalıştıran tedarikçiye — Amerika Birleşik Devletleri'ne, yedek tedarikçi devredeyse Çin Halk Cumhuriyeti'ne (Google hesabınızdan gelen veriler hariç — onlar yalnızca ABD'ye gider); (b) size gönderdiğimiz e-postaların adres ve içeriği, e-posta tedarikçimize (ABD); (c) anlık bildirim başlıkları, tarayıcınızın üreticisinin push sunucusuna; (d) sayfayı açtığınızda yazı tipi dosyalarını indirmek için IP adresiniz Google Fonts'a; (e) bağladığınız üçüncü taraf hizmetlere, yalnızca verdiğiniz izin kapsamında.",
    ...
    en: [
      ...
      },
      {
        ...
        p: [
          ...
          "The model is run by Anthropic, PBC (United States). To keep the service available, MiniMax and Z.ai (Zhipu AI) may be configured as fallback suppliers; the servers of these two are in the People's Republic of China. A fallback is used only when the primary supplier is temporarily unable to answer. Requests containing data from your Google account (such as Google Calendar events) are never sent to a fallback supplier; if Anthropic cannot answer at that moment, the request is not answered (see section 7).",
      ...
      },
      {
        ...
        p: [
          ...
          "Data leaves the country only in these cases: (a) the messages and context you send to Lio go to the supplier running the model — to the United States, or to the People's Republic of China if a fallback supplier is in use (except data from your Google account, which goes only to the United States); (b) the address and content of emails we send you go to our email supplier (USA); (c) push notification headlines go to your browser vendor's push server; (d) your IP address reaches Google Fonts when a page downloads font files; (e) to the third-party services you connect, within the scope you granted.",
