...
export const en: Dict = {
  ...
  nav: {
    ...
    packages: "Plans",
    groups: { product: "Product", pricing: "Pricing", support: "Support" },
    desc: {
      lio: "The AI assistant that speaks your language",
      journey: "From one sentence to done",
      features: "Board, calendar, budget, alerts",
      modules: "57 modules, department by department",
      screenshots: "A closer look at the interface",
      packages: "Starter, Pro and Business",
  ...
  modules: {
    ...
    hint: "Pick a department to see its modules right below.",
    moduleCount: "modules",
    prev: "Previous departments",
    next: "Next departments",
    items: [
      { slug: "yonetim", title: "Management", text: "Company-wide dashboard, goals, decision tracking and executive reports.", modules: ["Identity & direction", "Goal setting", "Analysis", "Reporting", "Audit", "Project management", "Programme management", "Output management", "Task management", "Budget management", "File management", "Accounts"] },
      { slug: "muhasebe", title: "Finance & Accounting", text: "Income and expense ledger, invoice tracking, cash flow and project budgets.", modules: ["Receivables & payables", "Invoices", "Financial planning", "Analysis & reports", "Tax tracking", "Budget preparation", "Cash flow", "Capital & investment tracking", "Risk management", "Accounts"] },
      { slug: "satis", title: "Sales", text: "Proposal pipeline, opportunity tracking, sales targets and close rates.", modules: ["Sales planning (B2B / B2C)", "Customers", "Partnerships & distribution", "Market research"] },
      { slug: "musteri", title: "Customers (CRM)", text: "Customers, suppliers and leads on one record, with the full contact history.", modules: ["Customers", "Complaints & suggestions", "Technical support"] },
      { slug: "pazarlama", title: "Marketing", text: "Campaign plans, content calendar, social media and ad budgets.", modules: ["Competitor & industry analysis", "Target audience", "Digital marketing", "SEO / SEM", "Social media", "Email", "Advertising", "Product strategy", "Customer acquisition optimisation", "Growth targets", "Brand identity"] },
      { slug: "ik", title: "Human Resources", text: "Hiring, leave, payroll tracking, performance and onboarding flows.", modules: ["Hiring & onboarding", "Training & development planning", "Performance tracking", "Payroll & personnel files", "Internal comms & culture"] },
      { slug: "uretim", title: "Production", text: "Work orders, production plans, capacity and quality control steps.", modules: ["Procurement", "Quality control"] },
      { slug: "lojistik", title: "Logistics & Inventory", text: "Stock, shipments, delivery tracking and warehouse movements.", modules: ["Warehouse", "Shipment management", "Procurement"] },
      { slug: "urun", title: "Product", text: "Roadmap, release planning, feedback pool and feature prioritisation.", modules: ["Products"] },
      { slug: "teknoloji", title: "Technology", text: "Development board, bug tracking, environments and access management.", modules: ["Software", "Hardware", "Network & security", "Accounts"] },
      { slug: "hukuk", title: "Legal & Contracts", text: "Contract archive, renewal alerts, approval flows and compliance checks.", modules: ["Contracts", "Trademark / patent / copyright", "Regulations"] },
    ],
  },

  journey: {
    eyebrow: "The life of a task",
    scenes: [
      { kicker: "Signal", title: "Work starts with a sentence.", text: "“Assign the Galata homepage to Ayşe for 11:00 tomorrow.” Lio doesn't ask for the date, the person and the project one by one." },
      { kicker: "Context", title: "Lio connects the pieces.", text: "It gathers the customer, the latest thread, the current budget and team workload around the same decision." },
      { kicker: "Action", title: "One command, the whole system updates.", text: "The task is created, an owner assigned, the calendar shifts and the budget view refreshes. What's left is deciding, not data entry." },
      { kicker: "Foresight", title: "It tells you before you ask.", text: "Lio doesn't just wait for commands. It spots the stuck step, estimates the impact and suggests the right move." },
    ],
    command: "Assign the Galata homepage to Ayşe for 11:00 tomorrow.",
    parsed: ["Galata", "Tomorrow 11:00", "Ayşe"],
    nodes: [["CRM", "Aydın Yapı"], ["BUDGET", "₺420K"], ["TEAM", "74% booked"], ["CALENDAR", "3 days"]],
    columns: ["To do", "In progress", "Done"],
    cards: [["Homepage design", "Galata · 11:00", "Tomorrow"], ["Proposal revision", "Aydın Yapı", "Today"], ["Team meeting", "Management", "09:24"]],
    toastTitle: "4 areas updated",
    toastText: "Task · Calendar · Team · Budget",
    insightLabel: "Lio insight",
    insightAgo: "12 seconds ago",
    insightLive: "LIVE",
    insightTitle: "Delivery risk on the Galata project.",
    insightText: "Content approval has been waiting for 2 days. If it's approved by 16:00 today, the plan holds.",
    riskLabel: "Delivery risk",
    impactLabel: "Impact",
    impactValue: "2 days",
    insightAction: "Start the approval flow",
  },
  ...
  pricing: {
    hero: {
      ...
      lede: "Three plans, one list. Every plan renews its Lio Units monthly; extra units are there for busy months.",
    },
    ...
    plans: [
      {
        key: "starter",
        name: "Starter",
        desc: "For solo workers and anyone getting started with Projelio.",
        priceMonthly: 4.99,
      ...
      },
      {
        key: "pro",
        name: "Pro",
        desc: "The full version for freelancers and small teams.",
        priceMonthly: 9.99,
      ...
      },
      {
        key: "business",
        name: "Business",
        desc: "For companies with departments and many parallel projects.",
        priceMonthly: 24.99,
  ...
  credits: {
    hero: {
      eyebrow: "Lio Units",
      title: "Lio Units come with your plan",
      lede: "Every plan includes Lio Units each month. If a busy month uses them up you can buy extra units; they cost more than the units in your plan, so for regular needs the next plan up is cheaper.",
    },
    packsTitle: "Extra Lio Units",
    packsLede: "For when your plan's monthly units run out. Extra Lio Units you buy never expire.",
    ...
    calcSuggestion: "Suggested plan per person",
    calcPerMonth: "units/month",
    calcNote: "Calculated over 22 working days. Lio Units belong to each person, so every user has their own plan.",
    usageTitle: "Lio Units consumption table",
    usageLede: "What an action costs depends on how much Lio reads and writes; the ranges are rounded from real usage. Anything you do in the panel costs nothing — only Lio uses Lio Units.",
    usageHead: ["Action", "Units"],
    /* Ranges from live usage; keep in sync with tr.ts and ORTALAMA_ISLEM_BIRIMI. */
    usage: [
      ["Short question or single action (create a task, check status)", "50–150"],
      ["Summary, report or multi-step job", "150–600"],
      ["Reading a document, long analysis", "600+"],
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: "What's the advantage of annual billing?", a: "Every plan is 20% cheaper on yearly billing — Pro, for example, comes to $7.99 a month instead of $9.99. You're also shielded from price increases for the year." },
  ...
  liveDemo: {
    meta: {
      title: "Live demo — let's set up Projelio together in 40 minutes",
      description: "A free 40-minute online session with our team: we'll set up Projelio for your work together. Pick a time that suits you.",
    },
    eyebrow: "Live demo",
    title: "Let's set up Projelio together in 40 minutes",
    lede: "In an online session with our team, we'll move your own work into Projelio together. Free, no sales pressure — pick a time that suits you.",
    facts: ["40 minutes", "Online · Google Meet", "Free"],
    agendaTitle: "What we do in the session",
    agenda: [
      { t: "We listen to how you work", d: "How your team works and where it gets stuck — we start there." },
      { t: "We set it up in your own account", d: "Your company, departments, first job and project — ready by the end of the call." },
      { t: "You see Lio at work", d: "Creating tasks in one sentence, getting summaries, finding files — with your data." },
      { t: "We answer your questions", d: "Plans, team invites, working with subcontractors, data security." },
    ],
    faqTitle: "Common questions",
    faq: [
      { q: "Is it paid?", a: "No. The session is free and doesn't tie you to any plan." },
      { q: "Do I need an account first?", a: "Not required, but recommended: we'll work directly in your account and everything we set up stays with you." },
      { q: "Who runs the session?", a: "Someone from the team building Projelio. Once assigned, we email you their name and the meeting link." },
      { q: "Can I change the time?", a: "Yes. Use the link in your confirmation email to move it to another time or cancel with one click." },
    ],
    booking: {
      title: "Pick a time",
      loading: "Loading calendar…",
      loadError: "The calendar couldn't be loaded. Try again in a few minutes.",
      closed: "Demo bookings are closed for now. They'll reopen soon; meanwhile you can write to us via the contact form.",
      empty: "No free slots in the coming days. Check back in a few days or write to us via the contact form.",
      tzNote: "Times are in Türkiye time (GMT+3).",
      tzDiff: "Your local time may differ.",
      ...
      note: "Anything in particular you'd like to see? (optional)",
      notePlaceholder: "E.g. assigning tasks to my team, budget tracking, social media calendar",
      consent: "I agree that my details are processed only to schedule this session.",
      consentLink: "Privacy notice",
      submit: "Confirm booking",
      sending: "Sending…",
      change: "Change time",
      genericError: "Couldn't book. Try again in a few minutes.",
      successTitle: "Request received",
      successText: "We've emailed {eposta}. Once we assign the team member who will host you, you'll get a confirmation email with the meeting link and add-to-calendar options.",
      inboxWarning: "If you can't see our email in your inbox, check the Promotions and Spam folders. Move it to Primary so the confirmation won't be missed either.",
      accountTitle: "Create your account before the session",
      accountText: "During the demo we'll work together in your own account. Create your free account with this email address beforehand so the whole session is spent on you.",
      accountCta: "Create my account",
      manage: "Reschedule or cancel",
      memberNote: "Already a member? You can also book from Settings > Helpers > Live demo in the app.",
    },
  },
