    ...
    tr: [
      {
        h: "1. Veri sorumlusu",
        p: [
          "6698 sayılı Kişisel Verilerin Korunması Kanunu (\"KVKK\") uyarınca veri sorumlusu sıfatıyla, kişisel verileriniz aşağıda açıklanan kapsamda işlenmektedir. Şirket unvanı, adres ve iletişim bilgileri sitenin altbilgisinde yer alır.",
        ],
      },
      {
        h: "2. İşlenen kişisel veriler",
        p: [
          "Kimlik: ad, soyad. İletişim: e-posta, telefon, adres. Müşteri işlem: abonelik, fatura ve ödeme kayıtları. İşlem güvenliği: IP adresi, log kayıtları, cihaz bilgisi. Mesleki deneyim: unvan, departman.",
        ],
      },
      {
        h: "3. İşleme amaçları",
        p: [
          "Hizmetin sunulması ve sözleşmenin ifası, faturalandırma ve muhasebe kayıtlarının tutulması, bilgi güvenliğinin sağlanması, talep ve şikâyetlerin karşılanması, yasal yükümlülüklerin yerine getirilmesi ve açık rıza bulunması halinde tanıtım faaliyetleri.",
        ],
      },
      {
        h: "4. Hukuki sebepler",
        p: [
          "KVKK m.5/2-c (sözleşmenin kurulması veya ifası), m.5/2-ç (hukuki yükümlülük), m.5/2-e (hakkın tesisi ve korunması), m.5/2-f (meşru menfaat) ve gerekli hallerde m.5/1 (açık rıza).",
        ],
      },
      {
        h: "5. Aktarım",
        p: [
          "Kişisel verileriniz; barındırma, ödeme, e-posta ve destek hizmeti aldığımız tedarikçilere, yetkili kamu kurumlarına ve mevzuattan doğan hallerde ilgili taraflara, amaçla sınırlı olarak aktarılabilir. Yurt dışına aktarım gereken hallerde KVKK m.9 çerçevesinde hareket edilir.",
        ],
      },
      {
        h: "6. Toplama yöntemi",
        p: [
          "Veriler; web sitesi ve uygulama formları, e-posta, WhatsApp üzerinden Lio ile yapılan yazışmalar ve otomatik sistem kayıtları aracılığıyla, kısmen otomatik yollarla toplanır.",
        ],
      },
      {
        h: "7. İlgili kişinin hakları",
        p: [
          "KVKK m.11 uyarınca; kişisel verinizin işlenip işlenmediğini öğrenme, bilgi talep etme, amaca uygun kullanılıp kullanılmadığını öğrenme, düzeltilmesini veya silinmesini isteme, aktarıldığı üçüncü kişileri öğrenme, otomatik analiz sonucu aleyhinize bir sonuç doğmasına itiraz etme ve zararın giderilmesini talep etme haklarına sahipsiniz.",
          "Başvurularınızı info@projelio.app adresine iletebilirsiniz; talepler en geç 30 gün içinde sonuçlandırılır.",
        ],
      },
    ],
    en: [
      {
        h: "1. Data controller",
        p: [
          "Under Turkish Personal Data Protection Law no. 6698 (\"KVKK\"), your personal data is processed as data controller within the scope described below. Company name, address and contact details appear in the site footer.",
        ],
      },
      {
        h: "2. Categories of data",
        p: [
          "Identity: first and last name. Contact: email, phone, address. Customer transactions: subscription, invoice and payment records. Transaction security: IP address, logs, device information. Professional details: title, department.",
        ],
      },
      {
        h: "3. Purposes",
        p: [
          "Providing the service and performing the contract, invoicing and accounting records, information security, handling requests and complaints, meeting legal obligations, and marketing activity where explicit consent exists.",
        ],
      },
      {
        h: "4. Legal grounds",
      ...
      },
      {
        h: "5. Transfers",
        p: [
          "Data may be transferred, limited to the purpose, to suppliers providing hosting, payment, email and support services, to authorised public bodies, and to relevant parties where legislation requires. International transfers follow KVKK art. 9.",
        ],
      },
      {
        h: "6. Collection method",
        p: [
          "Data is collected partly by automated means through website and application forms, email, conversations with Lio over WhatsApp, and automatic system records.",
        ],
      },
      {
        h: "7. Your rights",
        p: [
          "Under KVKK art. 11 you may learn whether your data is processed, request information, learn whether it is used for its purpose, request correction or deletion, learn the third parties it was transferred to, object to results arising from automated analysis, and claim compensation for damages.",
          "Send applications to info@projelio.app; requests are concluded within 30 days at the latest.",
        ],
      },
    ],
  },
